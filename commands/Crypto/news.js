...
module.exports = new Command()
  ...
  .addParameters(
    new Parameter()
      .setKey("query")
      .setDescription(
        "Choose what query you want the bot to find news articles for."
      )
      .setRequired(false),
    new Parameter()
      .setKey("language")
      .setDescription(
        "Choose the language you want the bot to find an article in:\nAR,DE,EN,ES,FR,HE,IT,NL,NO,PT,RU,SE,UD,ZH"
      )
      .setRequired(false)
  )
  ...
  .setCallback(async function (message, args, client) {
    try {
      ...
      let embed = new MessageEmbed()
        ...
        .setImage(urlToImage)
        .setTimestamp()
        .setFooter(`${name}`, "https://i.imgur.com/CLAoaG9.png");
