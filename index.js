...
client.once('ready', () => {
    ...
    client.user.setActivity(`${prefix} help | ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0)} users across ${client.guilds.cache.size} servers!`, {type: 'PLAYING'})
    ...
    setInterval(async () => {
        ...
        let i = 0;
        setInterval(() => client.user.setActivity(`${activities[i++ % activities.length]}`, {type: 'PLAYING'}), 17000);
